...
template <typename _Tp> void _S_bitree_node_increase_ref(bitree_node<_Tp>* _x);
/**
...
-> const bitree_node<_Tp>*;
template <typename _Tp> void _S_bitree_node_decrease_ref(bitree_node<_Tp>* _x);
};
